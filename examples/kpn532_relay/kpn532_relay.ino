...
#define KPN532_RELAY_VERBOSE 1  // or 1, be careful, verbose slow down the relay
#define KPN532_RELAY_RAW 1      // 0 = TgGetData, InDataExchange, TgSetData (WTX, slower, overall faster because ISO/DEP and no real deselect/hlt), 1 = TgGetInitiatorCommand, InCommunicateThru, TgResponseToInitiator (no WTX, faster, overall slower because of real deselect/hlt),
